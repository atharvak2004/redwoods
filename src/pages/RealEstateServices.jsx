...
function RealEstateServices() {
  return (
    <div>
      <HeroSection name="Real Estate Advisory" title="Our Business" title2="Real Estate Advisory" descr="Strategic services designed to optimise asset value and investment outcomes through disciplined analysis and market intelligence." img="/image03-2.png" />
      <ServicesSection />
