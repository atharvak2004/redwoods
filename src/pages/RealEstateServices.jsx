...
function RealEstateServices() {
  return (
    <div>
      <HeroSection name="Real Estate Advisory" title="Real Estate" title2="Advisory" descr="Strategic services designed to optimise asset value and investment outcomes through disciplined analysis and market intelligence." img="/RealEstateHeroBg.png" />
      <ServicesSection />
