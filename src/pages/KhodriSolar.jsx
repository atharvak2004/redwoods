...
function KhodriSolar() {
  return (
    <div>
      <HeroSection name="Khodri Solar Project" title="Khodri Solar" title2="Power Plant" descr="A pioneering solar energy initiative harnessing cutting-edge technology to deliver sustainable and efficient power solutions." img="/solar/khodri-right-hero.png" />
      <SolarInfo1 />
