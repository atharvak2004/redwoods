...
const completedProjects = [
  // {
  //   image: heritageImage,
  //   title: "Royal Orchid Heritage",
  //   description:
  //     "45 luxury suites restored from royal residence • Rajasthan (Delivered 2023)",
  // },
  // {
  //   image: heritageImage,
  //   title: "Fort Jaisalmer Retreat",
  //   description:
  //     "Award-winning fort restoration & adaptive reuse • Rajasthan (Delivered 2022)",
  // },
  // {
  //   image: heritageImage,
  //   title: "Tea Estate Lodge",
  //   description:
  //     "Colonial-era bungalow converted into boutique lodge • Assam (Delivered 2021)",
  // },
  // {
  //   image: heritageImage,
  //   title: "Merchant’s House Goa",
  //   description:
  //     "Portuguese heritage home revitalization • Goa (Delivered 2020)",
  // },
];
